...
import CalendlyComponent from "@/components/calendly.component";
...
export default function ContactUs() {
  ...
  return (
    <div id="contact-us" className="relative isolate bg-white px-6 py-16 sm:py-24 lg:px-8">
      <div
      ...
      <form className="mx-auto mt-16 max-w-xl sm:mt-20" onSubmit={onFormSubmit}>
        <div className="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
          ...
          <div className="sm:col-span-2">
            ...
            <div className="relative mt-2.5">
              ...
              <input
                ...
                id="phone"
                autoComplete="tel"
                className="block w-full rounded-md border-0 px-3.5 py-2 pl-20 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-500 sm:text-sm sm:leading-6"
                required
              />
            </div>
          </div>
          ...
          <Switch.Group as="div" className="flex gap-x-4 sm:col-span-2">
            ...
            <Switch.Label className="text-sm leading-6 text-gray-600">
              ...
              <a href="/privacy-policy" className="font-semibold text-blue-500">
                privacy&nbsp;policy
              </a>
              .
            </Switch.Label>
        ...
        <div className="mt-10">
          <button
            type="submit"
            className="block w-full rounded-md bg-blue-500 px-3.5 py-2.5 text-center text-sm font-semibold text-white shadow-sm hover:bg-blue-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-500"
          >
            Submit
          </button>
        </div>
