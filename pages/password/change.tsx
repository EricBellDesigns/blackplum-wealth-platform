...
export default function PasswordChange() {
  ...
  async function onFormSubmit(e) {
    ...
    const {repeat_password, ...formProps} = Object.fromEntries(formData);

    // Include the reset code in the payload object
    const payload = Object.assign({}, formProps, {reset_code});

    // Check if passwords match
    if (payload.password !== repeat_password) {
    ...
    try {
      ...
      await axiosInstance.post("/api/password/change", payload);
      ...
      // Redirect user back to login page after 1 second
      setTimeout(() => {
        router.push("/login");
  ...
  return (
    <RootLayout title="Password Change | Black Plum">
            ...
            <div className="mx-auto w-80">
              <div className="text-center">
                ...
                <p className="mt-2 leading-6 text-gray-500">
                  Update your password to regain<br />
                  access to your account.
                </p>
              </div>

              <div className="mt-6">
                {/* Render Password Change Status message */}
                {renderStatus()}
